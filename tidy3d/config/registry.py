...
class ConfigManagerProtocol:
    ...
    def on_section_registered(self, section: str) -> None:  # pragma: no cover - interface hook
        """Called when a new section schema is registered."""

    def on_handler_registered(self, section: str) -> None:  # pragma: no cover - interface hook
