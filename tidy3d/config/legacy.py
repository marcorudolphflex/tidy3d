...
class LegacyConfigWrapper:
    ...
    @property
    def frozen(self):  # pragma: no cover - legacy testing hook
        return self._frozen

    @frozen.setter
    def frozen(self, value):  # pragma: no cover - legacy testing hook
    ...
    def __setattr__(self, name: str, value: Any) -> None:
        ...
        elif name in {"logging_level", "log_suppression", "use_local_subpixel", "frozen"}:
            prop = getattr(type(self), name)
            prop.fset(self, value)  # type: ignore[attr-defined]
        else:
...
__all__ = ["LegacyConfigWrapper", "LegacyEnvironment", "LegacyEnvironmentConfig"]
